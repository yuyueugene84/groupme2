...
role :web, "groupme2.com"                          # Your HTTP server, Apache/etc
role :app, "groupme2.com"                         # This may be the same as your `Web` server
role :db,  "groupme2.com"   , :primary => true # This is where Rails migrations will run
